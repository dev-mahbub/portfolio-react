...
const TeamStyleTwo = () => {
    return (
        <>
            <div className="row wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                <div className="col-12">
                        ...
                        >
                            {
                                team_data.slice(6, 12).map((item) => (
                                    <SwiperSlide key={item.id}>
                                        <div className="team__wrap team__item text-center style-two">
                    ...
                    <div className="pagination__wrapper">
                        <div className="bd-swiper-dot-2 text-center"></div>
                    </div>
                </div>
            </div>
        </>
