...
const ServiceElementEight = () => {
    return (
        <>
            <div className="row g-5">
                {
                    services_data.slice(32, 36).map((item) => (
                        <div className="col-xxl-3 col-xl-4 col-lg-4 col-md-6  wow fadeInUp" data-wow-delay={item.wowDelay}
                            ...
                            <div className="service__wrapper service__item style-eight text-center">
...
export default ServiceElementEight;