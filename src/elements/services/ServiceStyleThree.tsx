    ...
    return (
        <>
            <div className="row g-5">
                {
                    services_data.slice(11, 15).map((item) => (
                        <div className="col-xxl-3 col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay={item.wowDelay}
                            ...
                            <div className="service__wrapper service__item style-three bordered-style text-center">
                                ...
                                <div className="service__content">
                                    ...
                                    <div className="service__more">
                                        <Link className="circle-btn is-hover" href={`/service/service-details/${item.id}`}> <span
                                            className="icon__box"><i className="fa-regular fa-arrow-right-long"> </i></span></Link>
                                    </div>
                                </div>
                            </div>
                        </div>
