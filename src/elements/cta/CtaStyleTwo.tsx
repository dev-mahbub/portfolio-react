...
import CtaBgImg from '../../../public/assets/images/bg/cta-bg-01.png';
import Link from 'next/link';
type TCtaProps = {
    ctaBorderClass?: string;
}
const CtaStyleTwo = ({ ctaBorderClass }: TCtaProps) => {
    return (
        <>
                                ...
                                <div className="cta__content-wrap">
                                    <div className="cta__content">
                                        <div className="section__title-wrapper">
                                            <div className="section__title-wrapper">
                                                <span className={`section__subtitle ${ctaBorderClass ? ctaBorderClass : "sec-border"}`}>SUBSCRIBE</span>
