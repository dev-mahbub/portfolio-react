    ...
    return (
        <>
            ...
            <div className="row g-5">
                {
                    blog_data.slice(19, 22).map((item) => (
                            ...
                            <section className="blog__wrap blog__item style-two bg-solid">
                                <div className="blog__thumb">
                                    ...
                                    <div className="blog__btn-circle">
                                        <Link href={`/blog/blog-details/${item.id}`} className="circle-btn is-bg-white">
                                ...
                                <div className="blog__content">
                                    <div className="blog__content-top">
                                        ...
                                        <div className="blog__meta">
                                            <span><i className="fa-light fa-calendar"></i>
                                                {item.date}
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="blog__content-bottom">
                                        <div className="blog__author">
                                            ...
                                            <div className="blog__author-info">
                                                ...
                                                <span className="blog__author-designation">{item.desination}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
export default LatestBlogEight;