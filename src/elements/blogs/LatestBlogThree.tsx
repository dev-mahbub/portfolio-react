    ...
    return (
        <>
            ...
            <div className="row g-5">
                {
                    blog_data.slice(5, 8).map((item) => (
                        <div className="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay={item.wowDelay} data-wow-duration="1s" key={item.id}>
                            <div className="blog__wrap blog__item style-three">
                                ...
                                <div className="blog__content">
                                    <div className="blog__meta">
                                        <span> <i className="fa-light fa-calendar"></i>{item.date}</span>
                                        <span> <i className="fa-light fa-comment"></i>
...
export default LatestBlogThree;