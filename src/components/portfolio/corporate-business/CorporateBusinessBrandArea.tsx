...
import brandShape from '../../../../public/assets/images/brand/shape/brand-shape-01.png';
//swiper
...
const CorporateBusinessBrandArea = () => {
    return (
        <>
            {/* -- brand area start -- */}

            <div className="brand__area brand-space p-relative">
                <div className="counter__bg include-bg is-bg-none" style={{ backgroundImage: `url(${brandShape.src})` }}>
                </div>
                <div className="brand__wrapper style-two wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                    <div className="container">
                        <div className="swiper brand__active">
                            ...
                            >
                                {
                                    brand_data.slice(12, 20).map((item) => (
...
export default CorporateBusinessBrandArea;